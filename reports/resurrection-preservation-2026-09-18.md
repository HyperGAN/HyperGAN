...
All 15 archive tags are published on origin. PR #299 advanced develop with preserved master ancestry; PR #298 landed the approved plan and continuity files. The legacy retirement changes are prepared separately and will integrate after the new reference runs. Remote legacy branch/PR retirement is pending.
