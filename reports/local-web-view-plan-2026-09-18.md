...
W1 is implemented by the core observation checkpoint. W2–W3 can follow as a small PR targeting `develop`, alongside the next CPU distributed update/recovery work. W4 uses the actual GPU/cluster qualification stages. This ordering delivers a useful viewer without making frontend work a prerequisite for numerical correctness.
