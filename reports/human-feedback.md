...
### 19. Gate the heavy tests so a plain `pytest` is fast (raised 2026-09-20)
...
**Status:** Implemented on branch `worktree-agent-a455e0dd6013d71aa`; the
coordinator records the develop merge SHA.
