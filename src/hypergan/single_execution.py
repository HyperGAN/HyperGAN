"""Synchronous CPU execution adapter; numerical state never leaves this side."""
...
class SingleProcessExecution:
    ...
    @staticmethod
    def environment():
        return {'runtime': runtime_info(), 'source': source_info()}
    ...
    def inference(self, bundle_dir, identity):
        ...
        self._boundary()
        self._trainer.artifact_identity = identity
        save_bundle(bundle_dir, self._trainer, self._last_batch)
