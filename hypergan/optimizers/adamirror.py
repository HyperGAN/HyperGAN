    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                if len(state) == 0:
                    state['step'] = 0
                    state['step_size'] = torch.tensor(0.0)
                ...
                p.data.addcdiv_(state['step_size'], exp_avg, denom)

                bias_correction1 = 1 - beta1 ** state['step']
                bias_correction2 = 1 - beta2 ** state['step']

                state['step_size'] = group['lr'] * math.sqrt(bias_correction2) / bias_correction1
                ...
                p.data.addcdiv_(-2 * state['step_size'], exp_avg, denom)
